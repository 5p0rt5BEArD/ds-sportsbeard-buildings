...
import {KomorebiHouse} from "../src/KomorebiHouse.sol";
...
contract Deployer is Script {
    ...
    function run() public {
        ...
        // deploy the house
        address contractAddress = address(new KomorebiHouse());
        bytes24 komorebiHouse = registerHouse(ds, extensionID, contractAddress, (string)("Komo Hacker House"), (string)("src/KomorebiHouse.js"));

        // dump deployed ids
        console2.log("BuildingKind", uint256(bytes32(komorebiHouse)));
    ...
    function registerHouse(
        ...
        public returns (bytes24 buildingKind) 
    {
