...
import {GreenGooShop} from "../src/GreenGooShop.sol";
...
contract Deployer is Script {
    ...
    function run() public {
        ...
        bytes24 greenGooShop = registerShop(ds, extensionID, contractAddress, (string)("Green Goo Shop"), (string)("src/GreenGooShop.js"));
