...
import {SportsShop} from "../src/SportsShop.sol";
...
contract Deployer is Script {
    ...
    function run() public {
        ...
        // deploy the shop
        address contractAddress = address(new SportsShop());
        bytes24 sportsShop = registerShop(ds, extensionID, contractAddress, (string)("Sports Shop"), (string)("src/SportsShop.js"));

        // dump deployed ids
        console2.log("BuildingKind", uint256(bytes32(sportsShop)));
